...
namespace ToDoList.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230801075544_rateDelete")]
    partial class rateDelete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDoList.Infrastructure.Data.Rate", b =>
                {
                    b.Property<Guid>("RateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("FirstStar")
                        .HasColumnType("int");

                    b.Property<int>("SecondStar")
                        .HasColumnType("int");

                    b.Property<Guid>("TaskFK")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("ThirdStar")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoList.Infrastructure.Data.Rate", b =>
                {
                    b.HasOne("ToDoList.Infrastructure.Data.DoneTask", "DoneTask")
                        .WithOne("Rate")
                        .HasForeignKey("ToDoList.Infrastructure.Data.Rate", "TaskFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DoneTask");
                });
